...
app.put("/editar-infos-usuario/:id", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET usuario_nome = '"+nome+"', nome_usuario = '"+username+"', usuario_email = '"+email+"', usuario_tipo = '"+tipo+"', usuario_status_registro = '"+status+"' WHERE usuario_ID = '"+id+"'")
...
app.get("/allusers", (_, res) => {
    ...
    let SQL = "SELECT usuario_id, usuario_nome, nome_usuario, to_char(usuario_data_criacao, 'DD/MM/YYYY'), usuario_status_registro, usuario_tipo FROM usuarios"
